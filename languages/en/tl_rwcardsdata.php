...
$GLOBALS['TL_LANG']['tl_rwcardsdata']['writtenOn'] = array( 'Written on', '' );
$GLOBALS['TL_LANG']['tl_rwcardsdata']['readOn']    = array( 'Read on', '' );
$GLOBALS['TL_LANG']['tl_rwcardsdata']['cardSent']  = array( 'Sent', '' );
$GLOBALS['TL_LANG']['tl_rwcardsdata']['cardRead']  = array( 'Read', '' );
