...
$GLOBALS['TL_LANG']['tl_module']['rwcards_thumb_box_width'] = array(
    'Wie breit sollen die Thumbnails der Karten in der Vorschau sein?',
    'Wie breit sollen die Thumbnails in der Vorschau der Karten sein?'
);
$GLOBALS['TL_LANG']['tl_module']['rwcards_thumb_box_height'] = array(
    'Wie hoch sollen die Thumbnails der Karten in der Vorschau sein?',
    'Wie hoch sollen die Thumbnails der Karten in der Vorschau sein?'
);
$GLOBALS['TL_LANG']['tl_module']['rwcards_email_text'] = array(
    'Empfängermail-Text',
    'Der Text welcher in der an den Empfänger versanden E-Mail enthalten ist. Sie können hier die Simple Tokens ##sender##,##receiver## und ##link## verwenden. Ist das Feld leer, wird ein Standardtext vom System versendet.'
);
