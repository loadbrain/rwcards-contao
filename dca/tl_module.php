 ...
 * Add palette
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['RWCards'] .= 'type;rwcards_per_attachement;rwcards_cards_per_row,rwcards_rows_per_page;rwcards_keep_cards;rwcards_thumb_box_width,rwcards_thumb_box_height;rwcards_thumbnail_width,rwcards_thumbnail_height';
